...
const Protfolio = () => {
  ...
  return (
    <div className="flex gap-20 bg-green-500 gallery">
      ...
      {/* <div className="right flex flex-col justify-center"></div> */}

      <div className=" max-w-md max-h-72 right">
        
      <div className=" max-w-md max-h-72 relative bg-indigo-500 ">


        {/* <div className="photo max-w-md max-h-72 absoulte top-0  left-0 "> */}
          <img
            className=" photo  w-full h-full object-cover absoulte top-0  left-0 z-0  "
          ...
          />
          <img
            className=" photo  w-full h-full object-cover absoulte  left-0 z-1 rounded-full "
            src="https://plus.unsplash.com/premium_photo-1721980274417-8d3d99e69ba0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyfHx8ZW58MHx8fHx8"
            alt="Bank of America"
          /><img
          className=" photo  w-full h-full object-cover absoulte top-0  left-0 "
          src="https://images.unsplash.com/photo-1722343655851-c996945db672?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxN3x8fGVufDB8fHx8fA%3D%3D"
          alt="Bank of America"
        /><img
        className=" photo  w-full h-full object-cover absoulte top-0  left-0 "
